...
export class TipoDeAcaoService {
  ...
  getAllTipoDeAcao(): Observable<ProcessoTipoDeAcao[]> {
    return this.http.get<ProcessoTipoDeAcao[]>(this.URL_API + '/api/Sistema/tipo-de-acao');
  }
  ...
  createTipoDeAcao(createTipoDeAcaoRequest: ProcessoTipoDeAcao): Observable<ProcessoTipoDeAcao> {
    ...
    return this.http.post<ProcessoTipoDeAcao>(this.URL_API + '/api/Sistema/add-tipo-de-acao', createTipoDeAcaoRequest);
  }
  ...
  updateTipoDeAcao(id: string, updateTipoDeAcaoRequest: ProcessoTipoDeAcao): Observable<ProcessoTipoDeAcao> {
    ...
    return this.http.put<ProcessoTipoDeAcao>(this.URL_API + '/api/Sistema/update-tipo-de-acao/' + id, updateTipoDeAcaoRequest);
  }

  deleteTipoDeAcao(id: string): Observable<ProcessoTipoDeAcao> {
    return this.http.delete<ProcessoTipoDeAcao>(this.URL_API + '/api/Sistema/delete-tipo-de-acao/' + id);
  }
}
