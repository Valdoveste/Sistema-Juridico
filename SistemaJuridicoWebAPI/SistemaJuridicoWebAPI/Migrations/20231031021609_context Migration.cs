        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PARTE_CONTRARIA = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VALOR_ORIGINAL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VALOR_ATUAL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    INPUT_ALTERADO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DATA_ALTERACAO = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PROCESSO_LOG_ALTERACOES", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_USUARIO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NOME_USUARIO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PATRONO_RESPONSAVEL_ANTERIOR = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DATA_ALTERACAO = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
